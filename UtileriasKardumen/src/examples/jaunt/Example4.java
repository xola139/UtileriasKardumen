...
public class Example4{
  public static void main(String[] args){
    try{
      ...
      userAgent.open(new File("/Users/erikmartinez/Documents/workspaceSTS/UtileriasKardumen/src/examples/jaunt/images.htm"));  //open the HTML (or XML) from a file (throws IOException)
