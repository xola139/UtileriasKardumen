...
public class Example21{
  public static void main(String[] args){
    try{
      ...
      userAgent.sendPUT("http://TARGET_SERVER/examples/hello.xml",     //send HTTP PUT Request with updated content
      ...
      */
      ...
      userAgent.sendDELETE("http://TARGET_SERVER/examples/hello.xml"); //send HTTP DELETE request
      System.out.println("DOCUMENT:\n" + userAgent.doc.innerXML());    //print retrieved Document
      */
    }
